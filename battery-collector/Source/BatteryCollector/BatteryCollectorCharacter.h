...
protected:
	...
	// アイテム収集ボタンが押されたときに呼び出される。収集範囲内に入っていたPickupを収集してバッテリーを回復させる。
...
private:
	...
	/* アイテムを収集できる範囲 */
	UPROPERTY(VisibleAnywhere, Category = Camera, meta = (AllowPrivate = "true"))
		class USphereComponent* CollectionSphere;

	/* バッテリーの値(リアルタイムに変化する方) */
